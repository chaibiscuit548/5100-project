...
knitr::kable(results_df, align = 'c', 
...
start_line <- grep("Coefficients", model_output1)  
end_line <- length(model_output1) 
...
# Find the line numbers dynamically based on a keyword
start_line <- grep("Coefficients", model_output2) 
end_line <- length(model_output2)  
