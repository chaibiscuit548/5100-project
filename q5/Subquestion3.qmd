---
title: "Subquestion 3: Government Expenditure"
author: "Kylie King"
output:
  html_document:
    self_contained: true
...
Expenditure data from https://fred.stlouisfed.org/series/FGEXPND. Data is stored in millions of USD (ie 4000 = $4 billion)
...
ggplot(pivoted_df, aes(x = p_exp_of_gdp, y = approval, color = party)) +
  ...
  labs(title = "Linearity check by party") +
    scale_color_manual(values = c("royalblue2", "firebrick4"))
