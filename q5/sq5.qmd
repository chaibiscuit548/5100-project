...
The main difference between the ANOVA test and the ANCOVA test is the addition of regression. In this situation, we are able to compare the covariances of different variables in different comnbinations, instead of simply comparing the means. This will allow us to compare the correlation between government expenditure and public trust between two categories, Republican and Democrat respondents. 

First we must prepare the data and check assumptions.
